...
restaurant1 = Restaurant(description="Here is where the description goes", name="Urban Burger")
...
restaurant2 = Restaurant(description="Here is where the description goes", name="Super Stir Fry")
...
restaurant1 = Restaurant(description="Here is where the description goes", name="Panda Garden")
...
restaurant1 = Restaurant(description="Here is where the description goes", name="Thyme for That Vegetarian Cuisine ")
...
restaurant1 = Restaurant(description="Here is where the description goes", name="Tony\'s Bistro ")
...
# Menu for Andala's
restaurant1 = Restaurant(description="Here is where the description goes", name="Andala\'s")
...
restaurant1 = Restaurant(description="Here is where the description goes", name="Auntie Ann\'s Diner ")
...
restaurant1 = Restaurant(description="Here is where the description goes", name="Cocina Y Amor ")
...
restaurant1 = Restaurant(description="Here is where the description goes", name="State Bird Provisions")
session.add(restaurant1)
session.commit()
